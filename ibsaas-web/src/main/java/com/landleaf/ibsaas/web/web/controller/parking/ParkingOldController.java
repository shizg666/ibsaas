 ...
 */
@RestController
@RequestMapping("/parking-old")
@Api(value = "/parking-old", description = "停车业务相关操作")
public class ParkingOldController extends BasicController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ParkingOldController.class);
