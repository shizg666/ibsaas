package com.landleaf.ibsaas.web.web.cache.redis.storage;
...
import com.landleaf.ibsaas.web.web.cache.redis.exception.RedisCacheStorageException;
import com.landleaf.ibsaas.web.web.cache.storage.IRemoteCacheStore;
    ...
    class StrongCacheTask extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    this.sleep(RedisConstants.STRONG_RETRY_INIT_INTERVAL);
