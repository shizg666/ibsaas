...
public class IbsaasWebApplication implements WebMvcConfigurer {
    ...
    public Docket createHvacRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.landleaf.ibsaas.web.web.controller.energy"))
                .apis(RequestHandlerSelectors.withClassAnnotation(Api.class))
                .paths(PathSelectors.any())
                .build();
    }
     ...
     */
    @Bean
    public Docket createEnergyRestApi() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("ibsaas")
                .description("ibsaas管理系统")
                .version("1.0")
     ...
     */
    @Bean
    public Docket createBuildingRestApi() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("ibsaas")
                .description("ibsaas管理系统")
                .version("1.0")
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.landleaf.ibsaas.web.web.controller.building"))
                .apis(RequestHandlerSelectors.withClassAnnotation(Api.class))
                .paths(PathSelectors.any())
                .build();
    }
