package com.landleaf.ibsaas.common.exception;


import com.landleaf.ibsaas.common.exception.parking.ErrorCode;
...
public class BaseException extends RuntimeException {
    ...
    public BaseException(ErrorCode errCode, String... errMsg) {
        super(errCode.getMsg());
        this.errCode = errCode;
        setErrMsg(errMsg,true);
    }
    
    public BaseException(ErrorCode errCode, String errMsg, Boolean isTransfer) {
        super(errMsg);
        this.errCode = errCode;
     ...
     * @param cause 异常
     */
    public BaseException(ErrorCode errCode, Throwable cause, String... errMsg) {
