...
import com.landleaf.ibsaas.client.parking.lifang.mq.utils.RandomUtil;
 ...
 */
@Component
public class ParkingMqProducer {

    public static final Logger LOGGER = LoggerFactory.getLogger(ParkingMqProducer.class);
